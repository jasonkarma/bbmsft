...
public class LoginViewModel: ObservableObject {
    ...
    public init(client: BMNetworkcl.NetworkClient = BMNetworkcl.NetworkClient.shared, authService: AuthService = AuthService.shared) {
        self.client = client
    ...
    public func login() async {
        ...
        do {
            ...
            let expiresAtString = dateFormatter.string(from: expirationDate)
